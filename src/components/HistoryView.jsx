  ...
  return (
    <div className="flex flex-col w-full gap-5 sm:gap-6 lg:gap-8 pb-24 lg:pb-8">
        ...
        <div className="col-span-1 bg-white rounded-2xl sm:rounded-3xl p-3.5 sm:p-5 lg:p-6 flex flex-col justify-between border border-slate-200 shadow-[0_2px_12px_rgba(11,28,48,0.03)] hover:border-slate-300 transition-all min-h-[105px] sm:min-h-[125px]">
          ...
          <div className="flex items-end justify-between gap-1.5 mt-3">
            <div className="flex items-baseline gap-1">
              <span className="font-display text-slate-900 text-2xl sm:text-3xl lg:text-[36px] font-black leading-none tracking-tight">
                {mergedTrips.length}
              </span>
          ...
          <div className="bg-slate-200/80 rounded-2xl sm:rounded-3xl border border-slate-200/90 p-[1px] gap-[1px] grid grid-cols-2 overflow-hidden shadow-xs">
            {paginatedTrips.map((trip) => {
              ...
              return (
                ...
                >
                  {/* Top: Customer name (Left) + Status badge (Right) on same line */}
                  <div className="flex flex-col gap-1">
                    <div className="flex items-center justify-between gap-1.5 min-w-0">
                      <h4 className="text-xs sm:text-base font-bold text-slate-900 truncate leading-snug flex-1 min-w-0" title={trip.customerName || trip.title}>
      ...
      {selectedTripForMap &&
        createPortal(
          <div
            className={`fixed inset-0 z-[99999] w-screen h-screen flex items-center justify-center p-3 sm:p-6 bg-slate-900/60 backdrop-blur-xs transition-all overflow-y-auto ${isClosingMapModal
          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-2.5 shrink-0">
                ...
                <div className="bg-slate-50 p-2.5 sm:p-3 rounded-2xl border border-slate-200/80 flex flex-col justify-between">
                  <div className="flex items-center justify-between gap-1">
                    <span className="text-slate-900 font-bold text-[14px] leading-snug">Bắt đầu</span>
                    <span className="material-symbols-outlined text-[17px] text-slate-500">schedule</span>
                  </div>
                  <div className="mt-1 flex flex-col">
                    ...
                    <span className="text-[11px] font-semibold text-slate-500 tabular-nums mt-0.5">
                ...
                <div className="bg-slate-50 p-2.5 sm:p-3 rounded-2xl border border-slate-200/80 flex flex-col justify-between">
                  <div className="flex items-center justify-between gap-1">
                    <span className="text-slate-900 font-bold text-[14px] leading-snug">Kết thúc</span>
                    <span className="material-symbols-outlined text-[17px] text-slate-500">flag</span>
                  </div>
                  <div className="mt-1 flex flex-col">
                    <span className="text-sm sm:text-base font-black text-slate-900 tabular-nums leading-tight">
                ...
                <div className="bg-slate-50 p-2.5 sm:p-3 rounded-2xl border border-slate-200/80 flex flex-col justify-between">
                  <div className="flex items-center justify-between gap-1">
                    <span className="text-slate-900 font-bold text-[14px] leading-snug">Quãng đường</span>
                    <span className="material-symbols-outlined text-[17px] text-slate-500">route</span>
                  </div>
                  <div className="mt-1 flex items-baseline gap-1">
                    <span className="font-display text-slate-900 text-base sm:text-xl font-black leading-tight tracking-tight tabular-nums">
                ...
                <div className="bg-slate-50 p-2.5 sm:p-3 rounded-2xl border border-slate-200/80 flex flex-col justify-between">
                  <div className="flex items-center justify-between gap-1">
                    <span className="text-slate-900 font-bold text-[14px] leading-snug">Tốc độ TB</span>
                    <span className="material-symbols-outlined text-[17px] text-slate-500">speed</span>
                  </div>
                  <div className="mt-1 flex items-baseline gap-1">
                    <span className="font-display text-slate-900 text-base sm:text-xl font-black leading-tight tracking-tight tabular-nums">
              ...
              <div className="flex items-center justify-end pt-0.5 shrink-0">
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-2 rounded-lg bg-slate-900 hover:bg-slate-800 text-white font-bold text-sm transition-all shadow-xs cursor-pointer active:scale-95 text-center"
                >
                  Đóng
                </button>
              </div>
